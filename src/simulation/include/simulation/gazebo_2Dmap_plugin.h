...
protected:
    ...
    static bool worldCellIntersection(const vector3d& cell_center, const double cell_length,
    ...
    static bool cell2index(int cell_x, int cell_y, unsigned int cell_size_x, unsigned int cell_size_y,
