...
// Default values
static const char kDefaultNamespace[] = "";
...
static const char kConnectGazeboToRosSubtopic[] = "connect_gazebo_to_ros_subtopic";
static const char kConnectRosToGazeboSubtopic[] = "connect_ros_to_gazebo_subtopic";

/// \brief    Special-case topic for ROS interface plugin to listen to (if present)
///           and broadcast transforms to the ROS system.
static const char kBroadcastTransformSubtopic[] = "broadcast_transform";
...
template <class T>
bool getSdfParam(const sdf::ElementPtr& sdf, const std::string& name, T& param, const T& default_value,
