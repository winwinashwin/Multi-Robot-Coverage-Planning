...
class BaseOptimizer(object):
    ...
    def __init__(self):
        self.pub = rospy.Publisher('number_of_agents', UInt8, queue_size=10, latch=True)
    ...
    def solve(cls, navigable_area, resolution):
        ...
        n_agents = np.ceil(np.sqrt(cls.TIME_GAIN * navigable_area/cls.CARDINALITY_GAIN))
...
class OptimizerFromOccupancyGrid(BaseOptimizer):
    ...
    def load_params(self):
        OptimizerFromOccupancyGrid.CARDINALITY_GAIN = rospy.get_param("~cardinality_gain")
