...
grids = [cv2.imread('cov0.pgm', cv2.IMREAD_GRAYSCALE), cv2.imread('cov1.pgm', cv2.IMREAD_GRAYSCALE),
         cv2.imread('cov2.pgm', cv2.IMREAD_GRAYSCALE), cv2.imread('cov3.pgm', cv2.IMREAD_GRAYSCALE)]
